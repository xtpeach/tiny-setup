...
if [[ ! -d "$INSTALL_DIR/component/xxl-job/xxl-executor/xxl-job-executor-base-2.3.1" ]]; then
  log_note "[remove tiny-file]" "$INSTALL_DIR/component/xxl-job/xxl-executor/xxl-job-executor-base-2.3.1" "not exists"
  exit 0
fi

# stop container
log_note "[remove xxl-admin]" "cd $INSTALL_DIR/component/xxl-job/xxl-executor/xxl-job-executor-base-2.3.1 && docker-compose down"
