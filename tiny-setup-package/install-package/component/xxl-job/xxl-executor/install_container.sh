...
cd $INSTALL_DIR/component/xxl-job/xxl-executor/xxl-job-executor-base-2.3.1
sed -i 's/DATASOURCE_PASSWORD: "12345678"/DATASOURCE_PASSWORD: "postgresql!123456"/g' $INSTALL_DIR/component/xxl-job/xxl-executor/xxl-job-executor-base-2.3.1/docker-compose.yml
docker-compose down
