...
cd $INSTALL_DIR/component/xxl-job/xxl-admin/xxl-job-admin-2.3.1
sed -i "s/DATASOURCE_PASSWORD: \"12345678\"/DATASOURCE_PASSWORD: \"$POSTGRESQL_PASSWORD\"/g" $INSTALL_DIR/component/xxl-job/xxl-admin/xxl-job-admin-2.3.1/docker-compose.yml
sed -i "s/REDIS_PASSWORD: \"admin1!3\"/REDIS_PASSWORD: \"$REDIS_PASSWORD\"/g" $INSTALL_DIR/component/xxl-job/xxl-admin/xxl-job-admin-2.3.1/docker-compose.yml
